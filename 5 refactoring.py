...
def house(Coordin_x, Coordin_y, height, colour_wall, colour_roof, colour_window):
    ...
    line(screen, (0, 0, 0), (Coordin_x + height // 8, Coordin_y - height // 4),
         (Coordin_x + 3 * height // 8, Coordin_y - height // 4), 2)
    line(screen, (0, 0, 0), (Coordin_x + height // 4, Coordin_y - 3 * height // 8),
         (Coordin_x + height // 4, Coordin_y - height // 8), 2)
    # window2
    ...
    line(screen, (0, 0, 0), (Coordin_x + 5 * height // 8, Coordin_y - height // 4),
         (Coordin_x + 7 * height // 8, Coordin_y - height // 4), 2)
    line(screen, (0, 0, 0), (Coordin_x + 6 * height // 8, Coordin_y - 3 * height // 8),
         (Coordin_x + 6 * height // 8, Coordin_y - height // 8), 2)
...
def sun(Coordin_x, Coordin_y, size_out, colour):
    ...
    for i in range(15):
        ...
        if mark:
            Coordinates.append(
                (int(Coordin_x + size_out * math.cos(angle)), int(Coordin_y + size_out * math.sin(angle))))
        else:
